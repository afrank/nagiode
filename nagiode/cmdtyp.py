...
CommandArguments = {
    "CMD_ADD_HOST_COMMENT": [ "host", "com_data", "persistent", "com_author" ],
    "CMD_ACKNOWLEDGE_HOST_PROBLEM": [ "host", "com_data", "sticky_ack", "com_author" ],
    "CMD_ADD_SVC_COMMENT": [ "host", "service", "com_data", "persistent", "com_author" ],
    "CMD_ACKNOWLEDGE_SVC_PROBLEM": [ "host", "service", "com_data", "sticky_ack", "com_author", "send_notification" ],
    "CMD_DISABLE_SVC_CHECK": [ "host", "service" ],
    "CMD_ENABLE_SVC_CHECK": [ "host", "service" ],
    "CMD_DISABLE_SVC_NOTIFICATIONS": [ "host", "service" ],
    "CMD_ENABLE_SVC_NOTIFICATIONS": [ "host", "service" ],
    "CMD_SCHEDULE_SVC_DOWNTIME": [ "host", "service", "com_author", "com_data", "fixed", "start_time", "end_time" ],
    "CMD_SCHEDULE_HOST_DOWNTIME": [ "host", "service", "com_author", "com_data", "fixed", "start_time", "end_time" ],
    "CMD_DISABLE_SVC_CHECK": [ "host", "ahas" ],
    "CMD_ENABLE_SVC_CHECK": [ "host", "ahas" ],
    "CMD_DISABLE_HOST_SVC_NOTIFICATIONS": [ "host", "ahas" ],
    "CMD_ENABLE_HOST_SVC_NOTIFICATIONS": [ "host", "ahas" ],
    "CMD_PROCESS_SERVICE_CHECK_RESULT": [ "host", "service", "plugin_state", "plugin_output" ],
    "CMD_SCHEDULE_SVC_CHECK": [ "host", "service", "start_time", "force_check" ],
}
...
ArgumentDefaults["start_time"] = datetime.datetime.now(ArgumentDefaults["tz"]).strftime(ArgumentDefaults["time_fmt"])
ArgumentDefaults["end_time"] = (datetime.datetime.now(ArgumentDefaults["tz"]) + datetime.timedelta(seconds=3600)).strftime(ArgumentDefaults["time_fmt"])
